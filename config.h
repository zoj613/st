 ...
 */
static char *font = "Inconsolata Nerd Font Mono:style=Bold:pixelsize=16.5:antialias=true:autohint=true";
...
unsigned int const highlightBg = 16, highlightFg = 15;
